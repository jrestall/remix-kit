...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create blues-stack-example-7355
  fly apps create blues-stack-example-7355-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blues-stack-example-7355
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blues-stack-example-7355-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'blues-stack-example-7355-staging' does not match app name in config file 'blues-stack-example-7355'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name blues-stack-example-7355-db
  fly postgres attach --app blues-stack-example-7355 blues-stack-example-7355-db

  fly postgres create --name blues-stack-example-7355-staging-db
  fly postgres attach --app blues-stack-example-7355-staging blues-stack-example-7355-staging-db
  ```
